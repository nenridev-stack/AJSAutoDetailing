...
export const faqCategories: FAQCategory[] = [
    ...
    questions: [
      {
        ...
        answer:
          'A basic wash typically takes 45 minutes to 1.5 hours depending on vehicle size and condition. Sedans are usually on the shorter end, while trucks and very dirty vehicles take longer.',
      },
      {
        id: 'duration-2',
        question: 'How long does a full interior + exterior detail take?',
        answer:
          'A full detail usually takes 3 to 5 hours depending on vehicle size and condition. We recommend planning for half a day. We will give you a more accurate time estimate after reviewing your vehicle photos.',
      },
      {
        id: 'duration-3',
        question: 'How long does ceramic coating take?',
        answer:
          'Ceramic coating is a multi-step process that typically requires 1 to 2 days. This includes paint correction, surface preparation, coating application, and curing time. We will coordinate drop-off and pick-up schedules with you.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    questions: [
      ...
      {
        id: 'prep-2',
        question: 'Should I remove car seats before my appointment?',
        answer:
          'Yes, please remove car seats, booster seats, and any aftermarket accessories you would like us to clean around (or under). This allows us to do a thorough job on the upholstery and carpet. We are not responsible for car seat reinstallation.',
      },
    ],
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          'Absolutely! You can reschedule by calling or emailing us at least 24 hours before your appointment at no charge. Same-day rescheduling is subject to availability and may incur a fee. We will do our best to accommodate your new preferred time.',
      },
    ],
  },
];
