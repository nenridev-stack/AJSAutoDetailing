      ...
      <section className="bg-black py-16 pt-24 text-center text-white">
        <div className="container mx-auto px-4">
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-gray-400">
            Get to know our passion for auto detailing and the people behind the
            shine.
          </p>
        </div>
      </section>
              ...
              <div>
                ...
                <div className="mt-6 space-y-4 text-gray-400">
                  ...
                  <p>
                    ...
                    deserves that new-car pride, regardless of make, model, or year.
                  </p>
                  <p>
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <ScrollReveal>
              <div className="rounded-xl border border-white/10 bg-white/5 backdrop-blur-lg p-8 transition-all hover:border-accent-500/50">
                ...
                <p className="mt-2 text-gray-400">
                  Factory-trained and certified as a Ceramic Pro coating installer,
                  ensuring proper application and warranty coverage
          ...
          <ScrollReveal>
            <div className="text-center">
              ...
              <p className="mx-auto mt-4 max-w-2xl text-gray-400">
                ...
                communities. Contact us to confirm availability at your location.
              </p>
            </div>
          </ScrollReveal>
