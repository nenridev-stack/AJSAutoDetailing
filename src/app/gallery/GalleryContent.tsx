...
export function GalleryContent() {
  ...
  // Build flat lightbox image list from filtered items
      ...
      <ScrollReveal>
        <section className="text-center pt-24 pb-8 md:pt-32 md:pb-12 px-4">
          ...
          <p className="text-lg md:text-xl text-gray-400 max-w-2xl mx-auto">
            Explore our before and after transformations from our detailing services.
            Every photo shows the quality and care we put into every vehicle.
          </p>
        </section>
      </ScrollReveal>
