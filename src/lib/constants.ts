...
export const VEHICLE_OPTIONS: VehicleOption[] = [
  {
    id: 'sedan',
    label: 'Sedan',
    description: 'Compacts, midsize, and coupes',
  ...
  },
  {
    id: 'suv',
    label: 'SUV / Crossover',
    description: 'Standard SUVs and crossovers',
    image: '/brand/suv.png',
  ...
  },
  {
    id: 'truck',
    label: 'Truck',
    description: 'Pickups and large vehicles',
...
export const SERVICE_PACKAGES: ServicePackage[] = [
  {
    ...
    name: 'Basic Wash',
    description:
      'A complete hand exterior wash and interior cleaning to keep your vehicle looking fresh between full details.',
    shortDescription: 'Hand exterior wash and interior cleaning',
    icon: 'Droplets',
    includedServices: [
      'Hand exterior wash',
  ...
  },
  {
    ...
    description:
      'Deep interior cleaning and full exterior polish. Restore your vehicle to showroom condition inside and out.',
    shortDescription: 'Deep interior cleaning and polished exterior',
    icon: 'Sparkles',
    includedServices: [
      'Full hand exterior wash and dry',
      'Clay bar treatment',
...
export const ADD_ONS: AddOn[] = [
  ...
  },
  {
    ...
    description: 'Restore cloudy and yellowed headlights to crystal-clear condition.',
    price: 50,
    icon: 'Lightbulb',
  },
  {
